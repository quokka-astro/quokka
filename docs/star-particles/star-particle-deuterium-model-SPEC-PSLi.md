...
At the transition from VariableCoreDeuterium to SteadyCoreDeuterium, the burnState is changed to ShellDeuterium.  radius becomes $2.1\times r$ and $n = 3$.  The factor 2.1 is applied only once to the radius.
