...
4. Verify `1e-6 × (T_min / T_floor)⁴ ≥ 10⁴`, i.e. `T_floor ≤ T_min / 316`.
   (E_photon cancels: `atol_rad_num / N_gamma_floor = (1e-6 × a_rad × T_min⁴ / E_photon) / (a_rad × T_floor⁴ / E_photon) = 1e-6 × (T_min / T_floor)⁴`.)
   Example: `T_min = 10 K`, `T_floor = 0.01 K` → ratio = `1e-6 × 1000⁴ = 10⁶` ✓.
