...
This diagnostic computes integrated fluxes through one or more spherical surfaces. The output is a fixed-width text file, similar in style to `DiagPDF`, with one row per requested radius.
