...
| `temperature_floor` | float | `2.7` (CGS), `0.0` (otherwise) | Minimum temperature, in kelvin for CGS and in code units otherwise. Clamps the cooling integration and sets its absolute tolerance. |
