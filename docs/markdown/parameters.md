...
| dust.omega_drag_heating       | Float         | `1.0`          | Controls deposition of the drag-like heating contribution in the dust source update. In `computeDustDragAndLorentz`, this is the total discrete kinetic-energy loss after subtracting the B-dependent residual. |
| dust.omega_magnetic_residual  | Float         | `0.0`          | Controls deposition of the B-dependent part of the discrete RK energy residual in `computeDustDragAndLorentz`.                                   |
