...
| particles.eps_ff                              | Float         | `0.01`                                                                                                        | Star formation efficiency per free-fall time. When `particles.eps_ff_ramp` is enabled this is the baseline value that the ramp scales up.                        |
| particles.eps_ff_ramp                         | Boolean (0/1) | `0` (Disabled)                                                                                                | If set to 1, `particles.eps_ff` is ramped up exponentially in cells that are large compared to their Jeans length. See the star formation section of `particles.md`. |
