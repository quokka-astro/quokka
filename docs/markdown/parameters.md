...
| Parameter Name               | Type          | Default                   | Description                                                                                                                                                                                                       |
|------------------------------|---------------|---------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| mhd.emf_compute_scheme       | String        | `"FelkerStone2018"`       | Determines the method used to compute the EMF at edges. Can be set to `FelkerStone2018`, `Balsara2025a`, or `Quokka2026`.                                                                                          |
