...
| particles.SN_use_galilean_invariant           | Boolean (0/1) | `1` (Enabled)                                                                                                 | Use Galilean-invariant formulation for momentum-based SN schemes. If 0, uses energy-conserving (lab-frame) formulation. See [Particles](particles.md) for details. |
