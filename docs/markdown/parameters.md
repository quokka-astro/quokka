...
| sfh_to_pe_heating_table        | String        | **Required** if `use_sfh_based_pe_heating = 1` and `const_sfr_Msun_per_year_per_kpc2 < 0`   | Path to the table converting star formation history to photoelectric heating.                                           |
