...
| mhd.emf_averaging_scheme     | String        | `"LondrilloDelZanna2004"` | Determines the method used to average EMF at edges. Can be set to `BalsaraSpicer2004` or `LondrilloDelZanna2004`.                                                                                                 |
