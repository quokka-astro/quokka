...
| particles.use_low_jeans_sf_failsafe           | Boolean (0/1) | `1` (Enabled)                                                                                                 | If set to 1, forces the stochastic star-formation probability to 1.0 when the local Jeans length falls below the low-Jeans truncation threshold.            |
