...
| Parameter Name | Type        | Description                                                                                                                                  |
| -------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| dust.enable_iter_stoptime    | Integer | If set to 1, enables iterative dust stopping time calculation. Default: 0 (disabled).                                                                                                 |
...
| dust.print_iteration_counts     | Integer | If set to 1, prints dust drag iteration counts for debugging. Default: 0 (disabled).                                                                                               |
...
| Parameter Name                             | Type    | Description                                                                                                                                                                                             |
| ------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| hydro.skip_advance                          | Integer | If set to 1, skips the hydrodynamics advance and copies the previous state forward. Useful for particle-only or feedback-only tests. Default: 0 (disabled).                                           |
...
| turbulence.target_vdisp      | Float   | Target turbulent velocity dispersion.                                                                                                                        |
...
| turbulence.sol_weight        | Float   | Solenoidal weight. Can be 0.0 (compressive driving), 1.0 (solenoidal driving) or 0.5 (natural mixture).                                                      |
