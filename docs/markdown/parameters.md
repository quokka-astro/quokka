...
| particles.stochastic_stellar_pop_kick_velocity_min | Float    | `3.0`                                                                                                         | Minimum runaway-kick speed for high-mass `StochasticStellarPop` particles, in km s\\(^{-1}\\). Must be positive.                                                |
| particles.stochastic_stellar_pop_kick_velocity_max | Float    | `385.0`                                                                                                       | Maximum runaway-kick speed for high-mass `StochasticStellarPop` particles, in km s\\(^{-1}\\). Must be at least the minimum kick speed.                         |
