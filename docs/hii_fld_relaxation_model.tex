...
The Python script above is a 1D spherical reference model. In Quokka, the corresponding implementation used by the H\,II-region temperature-floor path is a 3D Cartesian, GPU-parallel solve in
...
When \texttt{particles.use\_stromgren\_tempfloor = true}, Quokka:
\begin{enumerate}
