...
canary.directives.keywords("quokka", "nightly", "regression", "gpu", "cuda", "hydro", "shockcloud", "shockcloud_gpu")
canary.directives.parameterize("cpus,gpus", [(1, 1)])
canary.directives.timeout("4h")
canary.directives.link("../lib/quokka_canary.py")
canary.directives.copy(src="../../../inputs/ShockCloud_64_regression.toml", dst="ShockCloud_64_regression.toml")
...
CASE = {
    "test_name": "ShockCloud-GPU",
    "problem_name": "ShockCloud",
    "input_file": "ShockCloud_64_regression.toml",
