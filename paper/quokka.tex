...
\begin{figure}
    ...
    \caption{Density, velocity, and pressure profiles for the stationary shock tube test (\autoref{section:shocktube}). For comparison, we show the exact solutions for density, velocity, and pressure as circles of the same color.}
    \label{fig:shocktube}
\end{figure}
...
\begin{figure}
    ...
    \caption{\emph{Upper:} Density, velocity, and pressure profiles for the `LeBlanc' shock tube test problem (\autoref{section:leblanc}). For comparison, we show the exact solutions for density, velocity, and pressure as the circles of the same color. \emph{Lower:} The specific internal energy, with the exact solution shown as circles.}
    \label{fig:leblanc}
\end{figure}
...
\begin{figure}
    ...
    \caption{A Marshak wave test problem (\autoref{ssec:marshak}). The radiation temperature and gas temperature are shown as solid lines, with the diffusion solution shown as circles.}
    \label{fig:marshak}
\end{figure}
...
The source code and entire commit history for \textsc{Quokka} is hosted in this public \faGithub\href{https://github.com/BenWibking/quokka-code}{GitHub repository}. The version of the source code used to produce the results in this paper as well as the output files at the final timestep for the simulations shown in the Figures are permanently archived at Zenodo DOI:\textcolor{red}{ZZZ}.
