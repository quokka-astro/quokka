...
## Build & Test Commands
- **Build**: `cd build/clang-3d && ninja -j8 test_particle_radiation`
- **Run specific test**: `cd tests && ../build/clang-3d/src/problems/ParticleRadiation/test_particle_radiation ../inputs/ParticleRadiation.in`
