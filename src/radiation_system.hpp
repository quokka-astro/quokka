...
template <typename problem_t> class RadSystem : public HyperbolicSystem<problem_t>
{
	...
	template <FluxDir DIR>
	static void ReconstructStatesPPM(arrayconst_t &q, array_t &leftState, array_t &rightState, amrex::Box const &cellRange, amrex::Box const &interfaceRange, int nvars, const int iReadFrom=0, const int iWriteFrom=0);
