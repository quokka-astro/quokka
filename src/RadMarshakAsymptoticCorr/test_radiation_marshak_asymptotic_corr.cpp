...
//==============================================================================
/// \file test_radiation_marshak_asymptotic_corr.cpp
/// \brief Defines a test problem for radiation in the asymptotic diffusion regime with wavespeed correction.
///
...
#include "test_radiation_marshak_asymptotic_corr.hpp"
...
auto problem_main() -> int
{
	...
	sim.use_wavespeed_correction_ = true;
	...
	matplotlibcpp::save("./marshak_wave_asymptotic_corr_gastemperature.pdf");
#endif // HAVE_PYTHON
