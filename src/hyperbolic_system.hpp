									     ...
									     int k_in, int iReadFrom, int iWriteFrom)
{
	...
	{
		const int cand_i[] = {551,	  605,	      608,	  624,	      547,	  564,	      562,	  533,
				      1023 - 551, 1023 - 605, 1023 - 608, 1023 - 624, 1023 - 547, 1023 - 564, 1023 - 562, 1023 - 533};
		const int cand_j[] = {42, 33, 36, 27, 34, 30, 35, 57, 1023 - 42, 1023 - 33, 1023 - 36, 1023 - 27, 1023 - 34, 1023 - 30, 1023 - 35, 1023 - 57};
		for (int c = 0; c < 8; ++c) {
