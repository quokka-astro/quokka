#!/usr/bin/env bash
# Regenerates the helium network from this directory's
# jaffgen.toml/helium.jet. By default, clones jaff at the
...
OUTDIR="$(cd "${CONFIG_DIR}/../helium" && pwd)"
