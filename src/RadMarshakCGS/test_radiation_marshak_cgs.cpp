...
template <>
AMREX_GPU_HOST_DEVICE auto
RadSystem<SuOlsonProblemCgs>::ComputeTgasFromEgas(const double /*rho*/,
...
template <>
AMREX_GPU_HOST_DEVICE auto
RadSystem<SuOlsonProblemCgs>::ComputeEgasFromTgas(const double /*rho*/,
...
template <>
AMREX_GPU_HOST_DEVICE auto
RadSystem<SuOlsonProblemCgs>::ComputeEgasTempDerivative(const double /*rho*/,
                                                        const double Tgas)
    -> double {
