...
template <>
AMREX_GPU_HOST_DEVICE auto quokka::EOS<SuOlsonProblem>::ComputeTgasFromEint(const double /*rho*/ /*rho*/ const double Egas,
...
template <>
AMREX_GPU_HOST_DEVICE auto quokka::EOS<SuOlsonProblem>::ComputeEintFromTgas(const double /*rho*/ /*rho*/ const double Tgas,
									    std::optional<amrex::GpuArray<amrex::Real, nmscalars_>> const & /*massScalars*/ /*massScalars*/
    -> double
{
