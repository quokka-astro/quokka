...
template <>
AMREX_GPU_HOST_DEVICE auto ::quokka::EOS<SuOlsonProblem>::ComputeTgasFromEint(
...
template <>
AMREX_GPU_HOST_DEVICE auto ::quokka::EOS<SuOlsonProblem>::ComputeEintFromTgas(
...
template <>
AMREX_GPU_HOST_DEVICE auto ::quokka::EOS<SuOlsonProblem>::ComputeEintTempDerivative(
