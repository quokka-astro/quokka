...
auto problem_main() -> int
{
	...
	const Real T_cl = quokka::ResampledCooling::ComputeTgasFromEgas(rho1, Eint_cl, tables);
	...
	const Real T_post = quokka::ResampledCooling::ComputeTgasFromEgas(rho_post, Eint_post, tables);
