...
template <> struct HydroSystem_Traits<MetalCloud> {
	static constexpr bool reconstruct_eint = true;
};

template <> struct Physics_Traits<MetalCloud> {
	// cell-centred
...
template <> struct SimulationData<MetalCloud> {
	...
	amrex::Real primary_species_15{};
	amrex::Real primary_species_16{};
	amrex::Real primary_species_17{};
	amrex::Real primary_species_18{};
	amrex::Real primary_species_19{};
	amrex::Real primary_species_20{};
	amrex::Real primary_species_21{};
	amrex::Real primary_species_22{};
	amrex::Real primary_species_23{};
	amrex::Real primary_species_24{};
	amrex::Real primary_species_25{};
	amrex::Real primary_species_26{};
	amrex::Real primary_species_27{};
	amrex::Real primary_species_28{};
	amrex::Real primary_species_29{};
	amrex::Real primary_species_30{};
	amrex::Real primary_species_31{};
	amrex::Real primary_species_32{};
	amrex::Real primary_species_33{};
	amrex::Real primary_species_34{};
};

template <> void QuokkaSimulation<MetalCloud>::preCalculateInitialConditions()
{
	...
	userData_.primary_species_15 = 0.0e0_rt;
	userData_.primary_species_16 = 0.0e0_rt;
	userData_.primary_species_17 = 0.0e0_rt;
	userData_.primary_species_18 = 0.0e0_rt;
	userData_.primary_species_19 = 0.0e0_rt;
	userData_.primary_species_20 = 0.0e0_rt;
	userData_.primary_species_21 = 0.0e0_rt;
	userData_.primary_species_22 = 0.0e0_rt;
	userData_.primary_species_23 = 0.0e0_rt;
	userData_.primary_species_24 = 0.0e0_rt;
	userData_.primary_species_25 = 0.0e0_rt;
	userData_.primary_species_26 = 0.0e0_rt;
	userData_.primary_species_27 = 0.0e0_rt;
	userData_.primary_species_28 = 0.0e0_rt;
	userData_.primary_species_29 = 0.0e0_rt;
	userData_.primary_species_30 = 0.0e0_rt;
	userData_.primary_species_31 = 0.0e0_rt;
	userData_.primary_species_32 = 0.0e0_rt;
	userData_.primary_species_33 = 0.0e0_rt;
	userData_.primary_species_34 = 0.0e0_rt;
	...
	pp.query("primary_species_15", userData_.primary_species_15);
	pp.query("primary_species_16", userData_.primary_species_16);
	pp.query("primary_species_17", userData_.primary_species_17);
	pp.query("primary_species_18", userData_.primary_species_18);
	pp.query("primary_species_19", userData_.primary_species_19);
	pp.query("primary_species_20", userData_.primary_species_20);
	pp.query("primary_species_21", userData_.primary_species_21);
	pp.query("primary_species_22", userData_.primary_species_22);
	pp.query("primary_species_23", userData_.primary_species_23);
	pp.query("primary_species_24", userData_.primary_species_24);
	pp.query("primary_species_25", userData_.primary_species_25);
	pp.query("primary_species_26", userData_.primary_species_26);
	pp.query("primary_species_27", userData_.primary_species_27);
	pp.query("primary_species_28", userData_.primary_species_28);
	pp.query("primary_species_29", userData_.primary_species_29);
	pp.query("primary_species_30", userData_.primary_species_30);
	pp.query("primary_species_31", userData_.primary_species_31);
	pp.query("primary_species_32", userData_.primary_species_32);
	pp.query("primary_species_33", userData_.primary_species_33);
	pp.query("primary_species_34", userData_.primary_species_34);
...
template <> void QuokkaSimulation<MetalCloud>::setInitialConditionsOnGrid(quokka::grid const &grid_elem)
{
	...
	for (int n = 1; n <= NumSpec; ++n) {
		switch (n) {
			...
			case 14:
				...
				break;
			case 15:
				numdens[n - 1] = userData_.primary_species_15;
				break;
			case 16:
				numdens[n - 1] = userData_.primary_species_16;
				break;
			case 17:
				numdens[n - 1] = userData_.primary_species_17;
				break;
			case 18:
				numdens[n - 1] = userData_.primary_species_18;
				break;
			case 19:
				numdens[n - 1] = userData_.primary_species_19;
				break;
			case 20:
				numdens[n - 1] = userData_.primary_species_20;
				break;
			case 21:
				numdens[n - 1] = userData_.primary_species_21;
				break;
			case 22:
				numdens[n - 1] = userData_.primary_species_22;
				break;
			case 23:
				numdens[n - 1] = userData_.primary_species_23;
				break;
			case 24:
				numdens[n - 1] = userData_.primary_species_24;
				break;
			case 25:
				numdens[n - 1] = userData_.primary_species_25;
				break;
			case 26:
				numdens[n - 1] = userData_.primary_species_26;
				break;
			case 27:
				numdens[n - 1] = userData_.primary_species_27;
				break;
			case 28:
				numdens[n - 1] = userData_.primary_species_28;
				break;
			case 29:
				numdens[n - 1] = userData_.primary_species_29;
				break;
			case 30:
				numdens[n - 1] = userData_.primary_species_30;
				break;
			case 31:
				numdens[n - 1] = userData_.primary_species_31;
				break;
			case 32:
				numdens[n - 1] = userData_.primary_species_32;
				break;
			case 33:
				numdens[n - 1] = userData_.primary_species_33;
				break;
			case 34:
	...
	amrex::ParallelFor(indexRange, [=] AMREX_GPU_DEVICE(int i, int j, int k) {
		...
		state_cc(i, j, k, HydroSystem<MetalCloud>::x2Momentum_index) = state.rho * vy;
		state_cc(i, j, k, HydroSystem<MetalCloud>::x3Momentum_index) = state.rho * vz;
		state_cc(i, j, k, HydroSystem<MetalCloud>::internalEnergy_index) = e;

		Real const Egas = RadSystem<MetalCloud>::ComputeEgasFromEint(state.rho, state.rho * vx, state.rho * vy, state.rho * vz, e);
...
template <> void QuokkaSimulation<MetalCloud>::ErrorEst(int lev, amrex::TagBoxArray &tags, amrex::Real /*time*/, int /*ngrow*/)
{
	...
	for (amrex::MFIter mfi(state_new_cc_[lev]); mfi.isValid(); ++mfi) {
		...
		const int nidx = HydroSystem<MetalCloud>::density_index;
...
template <> void QuokkaSimulation<MetalCloud>::ComputeDerivedVar(int lev, std::string const &dname, amrex::MultiFab &mf, const int ncomp_cc_in) const
{
	...
	if (dname == "pressure") {
		...
		amrex::ParallelFor(mf, [=] AMREX_GPU_DEVICE(int bx, int i, int j, int k) noexcept {
			amrex::Real const Pgas = HydroSystem<MetalCloud>::ComputePressure(state[bx], i, j, k);
	...
	if (dname == "velx") {
		...
		amrex::ParallelFor(mf, [=] AMREX_GPU_DEVICE(int bx, int i, int j, int k) noexcept {
			Real const rho = state[bx](i, j, k, HydroSystem<MetalCloud>::density_index);
			Real const xmom = state[bx](i, j, k, HydroSystem<MetalCloud>::x1Momentum_index);
...
auto problem_main() -> int
{
	...
	// boundary conditions
	const int ncomp_cc = Physics_Indices<MetalCloud>::nvarTotal_cc;
	...
	QuokkaSimulation<MetalCloud> sim(BCs_cc);
