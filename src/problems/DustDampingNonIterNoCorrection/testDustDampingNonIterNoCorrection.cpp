/// \file testDustDampingNonIterNoCorrection.cpp
...
auto problem_main() -> int
{
	...
	if (!t_ref.empty() && !t.empty()) {
		...
		matplotlibcpp::save("./dust_damping_supersonic_gas_velocity_noiternoco.pdf");
		...
		matplotlibcpp::tight_layout();
		matplotlibcpp::save("./dust_damping_supersonic_dust1_velocity_noiternoco.pdf");
		...
		matplotlibcpp::tight_layout();
		matplotlibcpp::save("./dust_damping_supersonic_dust2_velocity_noiternoco.pdf");
		...
		matplotlibcpp::tight_layout();
		matplotlibcpp::save("./dust_damping_supersonic_gas_energy_noiternoco.pdf");
	}
#endif
