...
AMREX_GPU_MANAGED amrex::GpuArray<amrex::Real, ARR_SIZE> logphi_data{
    ...
    9.01193675, 9.01946449, 9.02689367, 9.03422652, 9.0414652,	9.04861178, 9.0556683,	9.06263668, 9.06951882}; // NOLINTEND
AMREX_GPU_MANAGED amrex::GpuArray<amrex::Real, ARR_SIZE> logg_data{
    ...
    -8.9214449,	 -8.9214447,  -8.92144451, -8.92144431}; // NOLINT
