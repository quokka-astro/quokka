...
AMREX_GPU_MANAGED amrex::GpuArray<amrex::Real, ARR_SIZE> logphi_data{ //NOLINT
...
AMREX_GPU_MANAGED amrex::GpuArray<amrex::Real, ARR_SIZE> logg_data{//NOLINT
...
AMREX_GPU_MANAGED amrex::GpuArray<amrex::Real, ARR_SIZE> z_data{ //NOLINT
