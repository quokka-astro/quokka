...
static constexpr amrex::GpuArray<amrex::Real, 1> dust_grain_radius = {0.01};
static constexpr amrex::GpuArray<amrex::Real, 1> dust_grain_density = {1.0};
...
template <>
AMREX_GPU_HOST_DEVICE auto DustSources<TurbulentBox>::ComputeReciprocalStoppingTime(amrex::Real rho_g, amrex::GpuArray<amrex::Real, nDustGroups_> rho_d,
