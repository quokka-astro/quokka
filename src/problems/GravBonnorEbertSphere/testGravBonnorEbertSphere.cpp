...
AMREX_GPU_MANAGED double t_stop_s = 1.0e8;    // NOLINT stopping time [s], << t_ff to enforce tight coupling. t_ff = 1.2e12 at critical density rho_c = 3.0e-18
AMREX_GPU_MANAGED double dust_fraction = 1.0; // NOLINT ρ_dust_total / ρ_gas (= f); dust density equals gas density
