...
grackle_data = np.genfromtxt('tests/sn_energy_history_grackle.csv', delimiter=',', skip_header=1)
resampled_data = np.genfromtxt('tests/sn_energy_history_resampled.csv', delimiter=',', skip_header=1)
