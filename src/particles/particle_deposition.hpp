...
struct RadDeposition {
							    ...
							    amrex::GpuArray<amrex::Real, AMREX_SPACEDIM> const &dxi) const noexcept
	{
		...
		interp.ParticleToMesh(p, radEnergySource, start_part_comp, start_mesh_comp, num_comp,
				      [=, this] AMREX_GPU_DEVICE(const ContainerType &part, int comp) {
...
struct MassDeposition {
							    ...
							    amrex::GpuArray<amrex::Real, AMREX_SPACEDIM> const &dxi) const noexcept
	{
		...
		interp.ParticleToMesh(p, rho, start_part_comp, start_mesh_comp, num_comp, [=, this] AMREX_GPU_DEVICE(const ContainerType &part, int comp) {
