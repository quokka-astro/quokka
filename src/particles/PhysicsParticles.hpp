...
class PhysicsParticleDescriptorBase
{
	...
	virtual void applySinkAccretion(amrex::MultiFab &state, amrex::MultiFab &state_accretion_rate, const amrex::Geometry &geom, int lev, amrex::Real time, amrex::Real dt)
	{ /* Default empty implementation */ }
...
class StarParticleDescriptor : public PhysicsParticleDescriptor<ContainerType, problem_t, particleType>
{
	...
	// apply accretion
	void applySinkAccretion(amrex::MultiFab &state, amrex::MultiFab &state_accretion_rate, const amrex::Geometry &geom, int lev, amrex::Real time, amrex::Real dt) override
	{
...
template <typename problem_t> class PhysicsParticleRegister
{
	...
	void applySinkAccretion(amrex::MultiFab &state, amrex::MultiFab &state_accretion_rate, const amrex::Geometry &geom, int lev, amrex::Real time, amrex::Real dt)
	{
		for (const auto &[type, descriptor] : particleRegistry_) {
			if (descriptor->getAllowsAccretion()) {
