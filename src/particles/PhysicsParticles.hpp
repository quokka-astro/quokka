...
// 	// Specialized nested ParticleChecker for Radiation particles
// 	template <typename problem_t> struct ParticleChecker {
// 		double param1;
// 		double param2;
// 		AMREX_GPU_HOST_DEVICE ParticleChecker(double t1, double t2) : param1(t1), param2(t2) {}
...
// 	// Specialized nested ParticleCreator for Radiation particles
// 	template <typename problem_t> struct ParticleCreator {
// 		int mass_idx;
// 		int cpu_id;
// 		amrex::Long pid_start;
...
// 	{
// 		// Use the common implementation with our checker and creator types
// 		ParticleCreationImpl::createParticlesImpl<problem_t, ContainerType, ParticleCreationTraits<ParticleType::Rad>::template ParticleChecker,
// 							  ParticleCreationTraits<ParticleType::Rad>::template ParticleCreator>(container, mass_idx, state, lev,
// 															  current_time, dt, param1, param2);
// 	}
// };
