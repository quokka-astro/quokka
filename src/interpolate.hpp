...
AMREX_GPU_HOST_DEVICE int64_t binary_search_with_guess(double key, const double *arr,
					int64_t len, int64_t guess);

AMREX_GPU_HOST_DEVICE void interpolate_arrays(double *x, double *y, int len,
