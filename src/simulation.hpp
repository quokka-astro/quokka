...
template <typename problem_t> class AMRSimulation : public amrex::AmrCore
{
	...
	double particle_param1 = -1.0;
	double particle_param2 = -1.0;
...
template <typename problem_t> void AMRSimulation<problem_t>::readParameters()
{
	...
	// Default particle_param1 = -1.0
	pp.query("particle_param1", particle_param1);

	// Default particle_param2 = -1.0
	pp.query("particle_param2", particle_param2);
...
template <typename problem_t> void AMRSimulation<problem_t>::InitPhyParticles()
{
	if (do_rad_particles != 0) {
		...
		particleRegister_.registerParticleType("Rad_particles", -1, quokka::RadParticleLumIdx, quokka::RadParticleBirthTimeIdx, particle_param1, particle_param2, false,
						       RadParticles.get());
	...
	if (do_cic_particles != 0) {
		...
		// Register with particle register
		particleRegister_.registerParticleType("CIC_particles", quokka::CICParticleMassIdx, -1, -1, particle_param1, particle_param2, false, CICParticles.get());
	...
	if (do_cic_rad_particles != 0) {
		...
		particleRegister_.registerParticleType("CICRad_particles", quokka::CICRadParticleMassIdx, quokka::CICRadParticleLumIdx,
						       quokka::CICRadParticleBirthTimeIdx, particle_param1, particle_param2, false, CICRadParticles.get());
