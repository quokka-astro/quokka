...
FewModesFT::FewModesFT(std::string prefix, int num_modes, const std::vector<std::vector<amrex::Real>> &k_vec, amrex::Real k_peak, amrex::Real sol_weight,
    ...
    : num_modes_(num_modes), prefix_(std::move(prefix)), 
      var_hat_real_d_(static_cast<std::size_t>(3) * static_cast<std::size_t>(num_modes)), 
      var_hat_imag_d_(static_cast<std::size_t>(3) * static_cast<std::size_t>(num_modes)), 
      k_vec_d_(static_cast<std::size_t>(3) * static_cast<std::size_t>(num_modes)),
      k_vec_(k_vec), k_peak_(k_peak), sol_weight_(sol_weight), t_corr_(t_corr), fill_ghosts_(fill_ghosts)
{
