...
find_index_in_sorted_vec(double x, std::vector<double> &v) -> std::size_t {
...
AMREX_GPU_HOST_DEVICE AMREX_INLINE auto
interpolate2d(double x, double y, std::vector<double> &xv,
              std::vector<double> &yv, amrex::Table2D<const double> &table)
    -> double {
