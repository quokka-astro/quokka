...
static constexpr bool force_rad_floor_in_iteration = true; // force radiation energy density to be positive (and above the floor value) in the Newton iteration
