...
#SBATCH -o /data/mfulghieri/ufficial_quokka/outputs/compilation/CMake_Compile.out
#SBATCH -e /data/mfulghieri/ufficial_quokka/outputs/compilation/CMake_Compile.err

# Determine repository root directory safely (avoiding Slurm /var/spool issue)
REPO_DIR=""    # initialize the var as an empty string
