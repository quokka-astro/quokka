...
!function(e, t) {
        ...
        _queueHooks : function(e, t) {
          ...
          return Y.get(e, n) || Y.access(e, n, {
            empty : S.Callbacks("once memory")
                        .add(function() { Y.remove(e, [ t + "queue", n ]) })
          })
        }
      }),
      S.fn.extend({
  ...
  function We(e, t, n) {
    ...
    return (n = n || Re(e)) &&
               ("" !== (a = n.getPropertyValue(t) || n[t]) || ie(e) ||
                    (a = S.style(e, t)),
                !y.pixelBoxStyles() && Pe.test(a) && Ie.test(t) &&
  ...
  var Be = [ "Webkit", "Moz", "ms" ], $e = E.createElement("div").style,
      _e = {};
  function ze(e) {
              ...
              get : function(e, t, n) {
                if (t)
                  return !Ue.test(S.css(e, "display")) ||
                             ...
                             ? Je(e, u, n)
                             : Me(e, Ve, function() { return Je(e, u, n) })
              },
              set : function(e, t, n) {
                var r, i = Re(e),
                ...
                return a && o &&
                           (s -= Math.ceil(
                                ...
                                parseFloat(i[u]) - Qe(e, u, "border", !1, i) -
                                .5)),
  ...
  S.Animation = S.extend(lt, {
    ...
    prefilter : function(
        e, t) { t ? lt.prefilters.unshift(e) : lt.prefilters.push(e) }
  }),
  S.speed =
      function(e, t, n) {
  ...
  S.fx.interval = 13, S.fx.start = function() { et || (et = !0, ot()) },
  S.fx.stop = function() { et = null },
  ...
  tt.type = "checkbox", y.checkOn = "" !== tt.value,
  y.optSelected = nt.selected, (tt = E.createElement("input")).value = "t",
    ...
    removeProp : function(
          ...
          tabIndex : {
            get : function(e) {
              ...
              return t ? parseInt(t, 10)
                     : pt.test(e.nodeName) || dt.test(e.nodeName) && e.href ? 0
                                                                            : -1
            }
          }
        },
      ...
      S.fn.extend({
        addClass : function(t) {
          ...
          if (m(t))
            return this.each(function(
                e) { S(this).addClass(t.call(this, e, gt(this))) });
          if ((e = vt(t)).length)
            while (n = this[u++])
        ...
        removeClass : function(t) {
          ...
          if (m(t))
            return this.each(function(
                e) { S(this).removeClass(t.call(this, e, gt(this))) });
          if (!arguments.length)
      ...
      return this
          ...
          .filter(function() {
            ...
            return this.name && !S(this).is(":disabled") &&
                   kt.test(this.nodeName) && !St.test(e) &&
  ...
  Mt.href = bt.href, S.extend({
    ...
    ajaxSetup : function(
        e,
        t) { return t ? Ft(Ft(e, S.ajaxSettings), t) : Ft(S.ajaxSettings, e) },
    ajaxPrefilter : It(Ot),
    ajaxTransport : It(Pt),
    ajax : function(e, t) {
      ...
      if (x.promise(T),
          v.url =
              ((e || v.url || bt.href) + "").replace(Ht, bt.protocol + "//"),
      ...
      for (i in (g = S.event && v.global) && 0 == S.active++ &&
           ...
           v.type = v.type.toUpperCase(), v.hasContent = !Lt.test(v.type),
           f = v.url.replace(jt, ""),
           v.hasContent
  ...
  y.cors = !!$t && "withCredentials" in $t, y.ajax = $t = !!$t,
              ...
              o &&
                  (o = a = r.onload = r.onerror = r.onabort = r.ontimeout =
                   ...
                   : "error" === e ? "number" != typeof r.status
                                   ...
                                   : t(Bt[r.status] || r.status, r.statusText,
  ...
  S.trim = function(e) { return null == e ? "" : (e + "").replace(Xt, "") },
