...
!function(n) {
  ...
  t.m = n, t.c = e, t.d = function(n, e, i) {
    ...
    var e = n && n.__esModule ? function() { return n.default }
                              : function() { return n };
    return t.d(e, "a", e), e
  }, t.o = function(n, e) {
  ...
  function(n, e, t) { t(1), n.exports = t(3) },
  function(n, e, t) {
    (function() {
      ...
      n.exports.ThemeNav = {
        ...
        enable : function(n) {
          ...
          void 0 === n && (n = !0),
              t.isRunning ||
                  (t.isRunning = !0, e((function(e) {
                     t.init(e), t.reset(), t.win.on("hashchange", t.reset),
                         n &&
                             t.win.on("scroll", (function() {
                                        t.linkScroll || t.winScroll ||
                                            (t.winScroll = !0,
        ...
        init : function(n) {
          n(document);
          var e = this;
          this.navBar = n("div.wy-side-scroll:first"), this.win = n(window),
          n(document)
              ...
              .on("click", ".wy-menu-vertical ul li a", (function() {
                    ...
                    n("[data-toggle='wy-nav-shift']").removeClass("shift"),
                        n("[data-toggle='rst-versions']").toggleClass("shift"),
                        e.toggleCurrent(t), e.hashChange()
                  }))
              .on("click", "[data-toggle='rst-current-version']", (function() {
                    n("[data-toggle='rst-versions']").toggleClass("shift-up")
                  })),
          n("table.docutils:not(.field-list,.footnote,.citation)")
              .wrap("<div class='wy-table-responsive'></div>"),
          n("table.docutils.footnote")
              .wrap("<div class='wy-table-responsive footnote'></div>"),
          n("table.docutils.citation")
          ...
          n(".wy-menu-vertical ul").not(".simple").siblings("a").each((function() {
            ...
            expand.on(
                "click",
                (function(
                    n) { return e.toggleCurrent(t), n.stopPropagation(), !1 })),
            t.prepend(expand)
          }))
        },
        reset : function() {
          ...
          try {
            ...
            if (0 === t.length) {
              var i = $('.document [id="' + n.substring(1) + '"]')
                          .closest("div.section");
        ...
        toggleCurrent : function(n) {
          ...
          t.length &&
              (t.removeClass("current").attr("aria-expanded", "false"),
               e.toggleClass("current").attr(
                   "aria-expanded",
                   (function(n, e) { return "true" == e ? "false" : "true" })))
        }
      },
      ...
      function() {
        for (var n = 0, e = [ "ms", "moz", "webkit", "o" ], t = 0;
             t < e.length && !window.requestAnimationFrame; ++t)
        ...
        window.requestAnimationFrame ||
            (window.requestAnimationFrame =
                 function(e, t) {
                   var i = (new Date).getTime(), o = Math.max(0, 16 - (i - n)),
                       r = window.setTimeout((function() { e(i + o) }), o);
                   return n = i + o, r
                 }),
            window.cancelAnimationFrame ||
  ...
  function(n, e) { n.exports = jQuery }, function(n, e, t) {}
]);
