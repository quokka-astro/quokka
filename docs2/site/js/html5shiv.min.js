...
!function(a, b) {
  ...
  function e(a, b) {
    ...
    "string" != typeof c && (c = c.join(" ")),
        "string" != typeof a && (a = a.join(" ")), t.elements = c + " " + a,
                                                   j(b)
  }
  function f(a) {
    var b = s[a[q]];
  ...
  function g(a, c, d) {
    ...
    d || (d = f(c));
    var e;
    return e = d.cache[a]  ? d.cache[a].cloneNode()
               : p.test(a) ? (d.cache[a] = d.createElem(a)).cloneNode()
                           : d.createElem(a),
           !e.canHaveChildren || o.test(a) || e.tagUrn ? e
  ...
  function i(a, b) {
    b.cache ||
        ...
        a.createElement = function(
            c) { return t.shivMethods ? g(c, a, b) : b.createElem(c) },
  ...
  !function() {
    try {
      ...
      a.innerHTML = "<xyz></xyz>", k = "hidden" in a,
